...
class __Mustache_88b08215759557342b62c2831bf6cac5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block7d6462fb0bc175d725dd9e0ca4ea1df1'),
            ));
...
';
    ...
    public function block7d6462fb0bc175d725dd9e0ca4ea1df1($context)
    {
        $indent = $buffer = '';
