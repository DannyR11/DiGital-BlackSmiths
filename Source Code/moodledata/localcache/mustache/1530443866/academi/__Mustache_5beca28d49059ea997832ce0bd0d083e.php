...
class __Mustache_5beca28d49059ea997832ce0bd0d083e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block291d205cc04d011bbb75cd00de1caece'),
            ));
...
';
    ...
    public function block291d205cc04d011bbb75cd00de1caece($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . '        <div class="fdate_time_selector d-flex flex-wrap">
';
