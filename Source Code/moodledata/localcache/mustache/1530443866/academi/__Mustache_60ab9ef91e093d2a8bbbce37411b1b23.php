...
class __Mustache_60ab9ef91e093d2a8bbbce37411b1b23 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockD0e8c5bfb8252103f4d7eaf4079c218c'),
            ));
...
';
    ...
    public function blockD0e8c5bfb8252103f4d7eaf4079c218c($context)
    {
        $indent = $buffer = '';
