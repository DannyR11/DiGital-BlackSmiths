...
class __Mustache_9ca83c06ba37a9d05e698edcfa9b26d5 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-author form-group row">
';
        $buffer .= $indent . '                    <label class="form-control-label col-4">';
        // 'str' section
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-license form-group row">
';
        $buffer .= $indent . '                    <label class="form-control-label col-4">';
        // 'str' section
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                        <select class="form-control"></select>
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-path form-group row">
';
        $buffer .= $indent . '                    <label class="form-control-label col-4">';
        // 'str' section
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-original form-group row">
';
        $buffer .= $indent . '                    <label class="form-control-label col-4">';
        // 'str' section
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-reflist form-group row">
';
        $buffer .= $indent . '                    <label class="form-control-label col-4">';
        // 'str' section
        $value = $context->find('str');
