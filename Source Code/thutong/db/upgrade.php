...
/**
 * This file keeps track of upgrades to the thutong module
 *
...
/**
 * Execute thutong upgrade from the given old version
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_thutong_upgrade($oldversion) {
    global $DB;
    ...
    // for demonstrative purposes and to show how the thutong
    // iself has been upgraded.

    // For each upgrade block, the file thutong/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field intro to be added to thutong
        $table = new xmldb_table('thutong');
        ...
        // Define field introformat to be added to thutong
        $table = new xmldb_table('thutong');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'thutong');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to thutong
        $table = new xmldb_table('thutong');
        ...
        // Define field timemodified to be added to thutong
        $table = new xmldb_table('thutong');
        ...
        // Define index course (not unique) to be added to thutong
        $table = new xmldb_table('thutong');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'thutong');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'thutong');
    }
