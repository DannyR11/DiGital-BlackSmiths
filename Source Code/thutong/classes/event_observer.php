...
/**
 * Event observer for thutong plugin
 *
 * @package    mod_thutong
 * @copyright  2018 Digital BlackSmiths
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
 namespace mod_thutong;
...
/**
 * Event observer for mod_thutong
 *
 * @package    mod_thutong
 * @copyright  2018 Digital BlackSmiths
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class event_observer{
    ...
    public static function course_deleted(\core\event\course_deleted $event) {
       global $DB;
		//MOD_THUTONG_TABLE should be deleted elsewhere
		...
		$ret = $DB->delete_records(MOD_THUTONG_USERTABLE,array('courseid'=>$event->objectid));
		return $ret;
	}
}
