    ...
    <body>
                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            <ul class="navbar-nav navbar-nav-right">
                                ...
                                <li class="nav-item"><a style="font-size: 12px" class="nav-item-child nav-item-hover" href="./faq.html">Jobs</a></li>
        ...
        <div class="parallax-window" data-parallax="scroll" data-image-src="img/MainPics/08.jpg">
            <div class="parallax-content container">
                <h1 class="carousel-title" style="color:#D35400;">Contact</h1>
