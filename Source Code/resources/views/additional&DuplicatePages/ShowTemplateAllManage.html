                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            <ul class="navbar-nav navbar-nav-right">
                                ...
                                <li class="nav-item"><a style="font-size: 20px" class="nav-item-child nav-item-hover" href="./ShowProfile/ShowProfiles.html">
                                    Admin: Dan Can</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 sm-margin-b-50">
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                            ...
                            <details>
                            <summary style="padding-left: 50px;"> <a style="font-size:30px"> Admin </a>
                            </summary>
                    ...
                    <div class="col-sm-6 sm-margin-b-50">
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                            ...
                            <details>
                            <summary style="padding-left: 50px;"> <a style="font-size:30px"> Expert </a>
                            </summary>
                    ...
                    <div class="col-sm-6 sm-margin-b-50">
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                            ...
                            <details>
                            <summary style="padding-left: 50px;"> <a style="font-size:30px"> Manager </a>
                            </summary>
                                <a style="padding-left: 50px;"> - Alicia alloy (Admin)</a> </br>
                                <a style="padding-left: 50px;"> - Lesego selel (Student) </a> </br>
                                <a style="padding-left: 50px;"> - Hairstylist & Colorist</a> </br>
                    ...
                    <div class="col-sm-6 sm-margin-b-50">
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                            ...
                            <details>
                            <summary style="padding-left: 50px;"> <a style="font-size:30px"> Student </a>
                            </summary>
                                <a style="padding-left: 50px;"> - Alicia alloy (Admin)</a> </br>
                                <a style="padding-left: 50px;"> - Lesego selel (Student) </a> </br>
                                <a style="padding-left: 50px;"> - Hairstylist & Colorist</a> </br>
                ...
                <div class="content-lg container">
                    <div class="row">
                        <div class="col-sm-5 sm-margin-b-30">
                            <h2 class="color-white"> Showing selected Profile</h2>
