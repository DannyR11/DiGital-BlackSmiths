                ...
                <div class="content-lg container">   
                    <div class="row">
                        ...
                        <div class="col-sm-5 sm-margin-b-30">
                            ...
                            <img onclick="window.location.href='./registerWithMail'" height="200" src="img/widgets/email.png" alt="ThutongLogoSize">
                            <img onclick="window.location.href='./fbRegistration'" height="200" src="img/widgets/facebook.png" alt="ThutongLogoSize"> </br>
                        </div>
                    </div>
                    <!--// end row -->
                </div>
