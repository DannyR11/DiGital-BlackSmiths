    ...
    ?>
        ...
        <div class="container" >
            ...
            <div >
                  ...
                  <?php   echo " <div class='col-md-6 col-sm-6 col-xs-6' ><div class='panel panel-default' style='background-color: rgba(150, 255, 285, 0.3);'>
                    ";


                    $subPic = $row['UserPic'];

                    echo " <h1 style='font-size:40px;'> Name: $row[UserName] </h1>
                           <h1 style='font-size:40px;'> Surname: $row[UserSurname] </h1>

                           <img src='ProfilePictures/anon.png' width='60%' height='260px'/>

                           <h1 style='font-size:20px;'> Email: <input type='text' placeholder='$row[UserEmail]'/> </h1>
                           
                           <h1 style='font-size:20px;'> Access level: <input type='text' placeholder='$row[UserLevel]'/> </h1>

                           <h1 style='font-size:20px;'> Password:  <input type='text' placeholder='$row[UserPassword]'/> </h1>

                         ";

                         ?>

                            <input  width="400px" height="360px" style="width:200px height:260px;" type="text" placeholder="I like swiming in the rain and long walks on the beach"/>
