...
<script type="text/javascript">
   ...
   <body <body background="Pictures/backround3.jpg">
                        ...
                        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                            <div class="container">
                                ...
                                <a href="profile.php" style="padding-left: 0.4cm; color:#3399ff; font-size:30px;"> User: : : <?php echo " " .$_SESSION["username"]. " " .$surname. " ";  ?></a>
                                    ...
                                    <a class="navbar-brand" href="main.php" id="colour" style="padding-left: 2cm;">Menu</a>
                                </div>
        ...
        $tag = "0";  
            ...
            echo "<h1 style='color:red'> ---- " . $tag . " ---- </h1>";
                ...
                if ( $check == "yes" )
                {
                        ...
                        $sql = "SELECT * FROM tbuser WHERE bookList = '" . $title . "'"; 
                        ...
                        if ( $row["name"] == $_SESSION["username"] )
                        {
                            ...
                            echo "<p> " . $row["name"] . " :: " . $_SESSION["username"] . " </p>";
                            $date = null;
                            ...
                            $no = 0;
                                ...
                                bookList='" . $no . "' WHERE user_id = '" . $_SESSION["user"] . "'"; 
                ...
                else
                {
                        ...
                        $lol = "no";
                        $sql = "SELECT * FROM tbbooks WHERE checkedIn = '" . $lol . "'"; 
                        $result = mysqli_query($conn, $sql);
                        ...
                        if ( $row["checkedIn"] == "no")
                        {
                                    ...
                                    $sql = "UPDATE tbuser SET
                                    bookList='" . $title . "' WHERE user_id = '" . $_SESSION["user"] . "'"; 
                ...
                echo "<a> check:" . $check . "</a>";


                $sql = "UPDATE tbbooks SET
                checkedIn='" . $check . "',
                review='" . $review . "',
                DateChecked= '" . $date . "' WHERE title = '" . $title . "'"; 
