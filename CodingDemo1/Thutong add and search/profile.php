...
<SCRIPT TYPE="text/javascript">  // Cloud
    ...
    ?>
                            ...
                            <div class="container">
                                ...
                                <div>
                                    ...
                                    <ul  class="nav navbar-nav">
                                        ...
                                        <li >
                                            <a href="profile.php" style=" color:purple;font-size:20px;"> <?php echo "| " . $admin . ": " .$_SESSION["username"]. " " .$surname. " ";  ?></a>
                                        </li>
        ...
        <div class="container" >
            ...
            <div >
                  ...
                  <?php   echo " <div style='padding-left: 50px;' class='col-md-6 col-sm-12 col-xs-12' ><div class='panel panel-default' style='background-color: rgba(150, 255, 285, 0.3);'>
                    ";


                    $subPic = $row['UserPic'];

                    echo " <h1 style='padding-left: 50px; font-size:40px;'> Name: $row[UserName] </h1>
                           <h1 style='padding-left: 50px; font-size:40px;'> Surname: $row[UserSurname] </h1>

                           <img style='padding-left: 50px;' src='ProfilePictures/anon.png' width='60%' height='260px'/>

                           <h1 style='padding-left: 50px; font-size:20px;'> Email: <input style='align:left' type='text' placeholder='$row[UserEmail]'/> </h1>
                           
                           <h1 style='padding-left: 50px; font-size:20px;'> Access level: <input type='text' placeholder='$row[UserLevel]'/> </h1>

                           <h1 style='padding-left: 50px; font-size:20px;'> Password:  <input type='text' placeholder='$row[UserPassword]'/> </h1>

                         ";

                         ?>

                           <h1 style='padding-left: 50px; font-size:20px;'> Bio:  <input style="width:350px; height:100px;" type="textbox" placeholder="I like swiming in the rain and long walks on the beach"/> </h1> 

                           <div style='padding-left: 250px; font-size:20px;'>
                ...
                <div class="col-md-4 col-sm-12 col-xs-12" >
                        ...
                        <img style="width: 100%; height: 400px;" src="CategoryPictures/ipad.jpeg"/> </br>
                </div>
    ...
    <div class="panel panel-primary" style="background-color: rgba(255, 255, 255, 0.6); " onmouseover="this.style.background='rgba(255, 0, 0, 0.3)';" onmouseout="this.style.background='rgba(255, 255, 255, 0.3)';">               
        <a style="padding-left: 0.4cm; color:purple; font-size:40px;"> Recents History: </a> <button onclick="location.href='GategoryAddData.php';" type="hidden" id="authentic" > Admin Add Subjects (Show/Hide)</button> </div>
    </div>
                    ...
                    $resultss = mysqli_query($db, $sqlss);
                            ...
                            if (mysqli_num_rows($resultss) >= 0) 
                            {
                                ...
                                while ($rowss = mysqli_fetch_array($resultss, MYSQLI_ASSOC)) 
                                {
                                    ...
                                    echo " 
                                                <a font-size:16px;' href='ShowLesson.php'>* $rowss[GradeName] </a>
