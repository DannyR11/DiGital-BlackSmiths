		...
		<div class="container" >
			...
			<div class="col-md-6 col-sm-8 col-xs-8">
					...
					<div class="panel panel-default" style="background-color: rgba(255, 255, 285, 0.5); " onmouseover="this.style.background='maroon';" onmouseout="this.style.background='rgba(255, 255, 285, 0.5)';">
						...
						<div href="ShowLesson.php">
							<a style="color:red;" href="ShowLesson.php" > Lesson Mockup </a>
					

						<img  style="width: 100%; height: 80%;" src="Pictures/M1.png"/>
				...
				<div class="col-md-4 col-sm-8 col-xs-12">
						...
						<img style="width: 100%; height: 400px;" src="LearningQuotesImages/Learning-Quotes-15-of-16.jpg"/>
